      ...
      >
        ...
        <div className="mt-2.5 pt-2 border-t border-white/10 space-y-1.5">
          <div className="flex items-center justify-between text-micro font-bold uppercase tracking-wider text-zinc-400">
            ...
            <span className="flex items-center gap-1 text-nano font-mono text-emerald-400">
          ...
          <div className="grid grid-cols-2 gap-1.5">
            ...
            >
              <div className="flex items-center justify-between w-full">
                ...
                <span className="flex items-center gap-1 text-nano font-bold px-1.5 py-0.5 rounded bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 animate-pulse">
                  ...
                  >
                    ...
                    {(layer.category === 'topo' || layer.category === 'satellite' || layer.category === 'ocean' || !!layer.renderStyle || !!layer.elevationEncoding) && (
                      <div className="space-y-1.5 pt-1.5 border-t border-white/10 text-micro">
                        <div className="flex items-center gap-1.5">
                          <span className="text-emerald-400 font-bold text-nano uppercase tracking-wider">3D Relief:</span>
                          <input
                            ...
                            className="w-full slider-archival cursor-pointer h-1 rounded-[1px]"
                          />
                          <span className="w-8 text-right font-bold text-emerald-300 text-nano tabular-nums">{(layer.displacementScale ?? preset?.defaultDisplacementScale ?? 0.08).toFixed(2)}</span>
                        </div>
                        ...
                        {(layer.renderStyle === 'architectural' || layer.id === 'architectural-topo-relief') && (
                          <div className="pt-1 border-t border-white/10 space-y-1">
                            <div className="flex items-center gap-1.5">
                              <span className="text-zinc-400 font-bold text-nano uppercase tracking-wider">Crevice AO:</span>
                              <input
                                ...
                                className="w-full slider-archival cursor-pointer h-1 rounded-[1px]"
                              />
                              <span className="w-8 text-right font-bold text-zinc-300 text-nano tabular-nums">{Math.round((layer.ambientOcclusion ?? 0.65) * 100)}%</span>
                            </div>
                            <div className="flex items-center justify-between text-nano text-emerald-400 font-mono">
                        ...
                        {(layer.renderStyle === 'hybrid' || layer.id === 'hybrid-crust-hydrosphere') && (
                          <div className="pt-1 border-t border-white/10 space-y-1.5">
                            <div className="flex items-center gap-1.5">
                              <span className="text-cyan-400 font-bold text-nano uppercase tracking-wider">Sea Level:</span>
                              <input
                                ...
                                className="w-full slider-archival cursor-pointer h-1 rounded-[1px]"
                              />
                              <span className="w-8 text-right font-bold text-cyan-300 text-nano tabular-nums">
                                {(layer.seaLevelOffset ?? 0) > 0 ? `+${layer.seaLevelOffset}m` : `${layer.seaLevelOffset ?? 0}m`}
                              </span>
                            </div>

                            <div className="flex items-center gap-1.5">
                              <span className="text-sky-400 font-bold text-nano uppercase tracking-wider">Clarity:</span>
                              <input
                                ...
                                className="w-full slider-archival cursor-pointer h-1 rounded-[1px]"
                              />
                              <span className="w-8 text-right font-bold text-sky-300 text-nano tabular-nums">{Math.round((layer.waterClarity ?? 0.75) * 100)}%</span>
                            </div>
          ...
          >
            <div className="flex items-center justify-between border-b pb-3 border-white/10">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-micro font-bold uppercase tracking-wider">Cartographic Data Catalog</h3>
              </div>
              <button
